                    ...
                    <form action="{{  route('siswa.update') }}" method="POST">
                        ...
                        @method('PUT')
                                ...
                                <div class="form-froup mb-3">
                                    ...
                                    <textarea name="alamat" id="alamat" id="alamat" class="form-control">{{$siswa->alamat}}</textarea>
                                    @error('nis')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-froup mb-3">
                                    ...
                                    <div class="form-check">
                                        ...
                                        name="jenis_kelamin" id="jenis-kelamin_l" value="L" @if ($siswa-.jenis_kelamin -- 'L') checked @endif>
                                        <label for="jenis_kelamin_l" class="form-check-label">Laki-Laki</label>
                                    </div>

                                    <div class="form-check">
                                        <input type="radio" class="form-check-input"
                                        name="jenis_kelamin" id="jenis-kelamin_p" value="P" @if ($siswa-.jenis_kelamin -- 'P') checked @endif>
                                ...
                                <div class="form-froup mb-3">
                                    ...
                                    <input type="text" name="tanggal_lahir" id="tanggal_lahir" value="{{ siswa->tanggal_lahir }}" class="form-control"/>
                                </div>
